...
from .VoxelNNet import VoxelNNet as NNet
...
class NNetWrapper(NeuralNet):
    def __init__(self, game, args):
        ...
        self.board_z = self.nnet.board_z
    ...
    def train(self, examples, lr=0.001):
        ...
        for epoch in range(args.epochs):
            ...
            while batch_idx < int(total_examples / args.batch_size):
                ...
                boards = boards.view(-1, 1, self.board_x, self.board_y, self.board_z)
    ...
    def load_checkpoint(self, folder='checkpoint', filename='checkpoint.pth.tar'):
        ...
        print("Loaded checkpoint %s"%(filepath))